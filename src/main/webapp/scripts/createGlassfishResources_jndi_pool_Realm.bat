...
set bin="C:\Users\fred\glassfish-4.1\glassfish\bin"

set DATABASE_PORT="3306"
set DATABASE_PASSWORD="itstudies12345"
set DATABASE_USER="root"
set DATABASE_NAME="csd322_security_demo_2015_Fred_Carella_mvn_git"
set CONNECTION_POOL_NAME="csd322_security_demo_2015_Fred_Carella_mvn_git_connectionPool"
set JNDI_NAME="jdbc/csd322_security_demo_2015_Fred_Carella_mvn_git"
set USER_NAME="username"
set PASSWORD="password"
set GROUP_NAME="group_name"
set GROUP_TABLE="v_user_role"
set USER_TABLE="v_user_role"
set REALM_NAME="csd322_security_demo_2015_Fred_Carella_mvn_git_Realm"
...
REM One last thing to note is that the server must be started in order for these commands to work.
